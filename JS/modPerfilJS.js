$(document).ready(function(){
    ...
    formMod.submit(function(e){
        ...
        if(validarPwd() && validarNombre() && validarApellidos() && validarEdad() && validarSexo() && validarPeso() && validarAltura()){
            $.ajax({
                type: "POST",
                url: "PHP/modPerfil.php",
                data:{
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(respuesta.result != undefined){
                    ...
                    inputPwd.val(respuesta.pwd);
                    inputNombre.val(respuesta.nombre);
                    inputApellidos.val(respuesta.apellidos);
                    inputEdad.val(respuesta.edad);
                    selectSexo.val(respuesta.sexo);
                    inputPeso.val(respuesta.peso);
                    inputAltura.val(respuesta.altura);
                }
            }
        })
    }
